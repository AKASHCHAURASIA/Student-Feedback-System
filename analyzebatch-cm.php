        ...
        <nav class="navbar-default navbar-static-side" role="navigation">
            ...
            <div class="sidebar-collapse" >
                ...
                <ul class="nav" id="side-menu" style="background-color:#323232;">
                    ...
                    <li>
                        <a href="cmhod.php"><i class="fa fa-home fa-fw"></i> Home<span ></span></a>
                    </li>
                    <li class="selected">
                        <a href="analyzefeedback-cm.php"><i class="fa fa-bar-chart-o fa-fw"></i> Analyze Feedback <span ></span></a>
                    </li>
                    <li>
