    ...
    <div id="wrapper" >
            ...
            <div class="sidebar-collapse" >
                ...
                <ul class="nav" id="side-menu" style="background-color:#323232;">
                   ...
                   <li class="selected">
					...
					<li>
                        <a href="subquestion.php"><i class="fa fa-bar-chart-o fa-fw"></i>Update feedback Question <span ></span></a>
                    </li>
                    <li>
        ...
        <div id="page-wrapper">
            ...
            <div class="row">
                <!-- Page Header -->
                <div class="col-lg-12">
                    <h1 class="page-header" style="font-size: 18px;">Feedback Analysis:Previous Feedback</h1>
                </div>
                
<div id='go'>
                    <div class="showcase" id="">
                            <li class="a"> 
                                <a href="subfeedback_report.php"><img src="assets/img/thumb1.jpg" alt="web3canvas">
                            ...
                            <li class="a">
                                <a href="subfeedbackreport1.php"><img src="assets/img/thumb2.jpg" alt="web3canvas">
