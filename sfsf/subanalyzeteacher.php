...
str=str+","+str2;
	   ...
	   var xmlhttp = new XMLHttpRequest();
        ...
        xmlhttp.open("GET", "faculty.php?q="+str, true);
        xmlhttp.send();
        ...
        <nav class="navbar-default navbar-static-side" role="navigation">
            ...
            <div class="sidebar-collapse" >
                ...
                <ul class="nav" id="side-menu" style="background-color:#323232">
                    ...
                    <li>
                        <a href="subquestion.php"><i class="fa fa-flask fa-fw"></i> Update feedback questions</a>
                    </li>
                    <li>
        ...
        <div id="page-wrapper">
            ...
            <div class="row">
              ...
              <div class="form-group col-lg-3">
                <label>Branch</label>
                <select id='kl' class="form-control select2 select2-hidden-accessible" style="width: 100%" tabindex="-1" aria-hidden="true" onmouseup="s1()"   >
			...
			<center> <button style='margin-top:10%' onmouseup='s2()'  class="btn btn-primary" style=" margin-top: -35px position: absolute left: 330px"><span style="color: white">Search</span></button></center>	
