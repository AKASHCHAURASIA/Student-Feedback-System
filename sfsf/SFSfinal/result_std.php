...
$res = mysqli_query($conn, "SELECT * FROM `cm_feed` WHERE teacher_name='$teacher' AND year='$year' AND sec='$u_group' AND sub_code='$sub' ");
	$data = array();
	$i = 0;
...
<body>
        ...
        <nav class="navbar-default navbar-static-side" role="navigation">
            ...
            <div class="sidebar-collapse">
                ...
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        <a href="#"><i class="fa fa-clock-o fa-fw"></i>Feedback Reports</a>
                    </li>
                    <li>
   ...
   <?php     $res = mysqli_query($conn, "SELECT * FROM ques");
	...
	$res1 = mysqli_query($conn, "SELECT * FROM users WHERE year='$year' AND chk=1 AND branch = '$branch' AND u_group='$u_group'");
