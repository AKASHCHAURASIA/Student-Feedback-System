...
$_SESSION['sem']=$sem;
		echo $sem;
		header ("Location: analyzeadmin2.php");
        ...
        <div id="page-wrapper">
            ...
            <div class="row">
			  ...
			  <div id='ty'>
                ...
                <center>
                    <button onmouseup='s2()'  class="btn btn-primary" style=" margin-top: -35px; position: absolute; left: 330px;"><span style="color: white">Search</span></button>
                </center>
