...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="row">
                <!-- Page Header -->
                <div class="col-lg-12">
                    <h1 class="page-header">Feedback Form For <?php 
					   $SQL = "SELECT * FROM users WHERE user='$t'";
		$res = mysqli_query($conn, $SQL);
		while ($db_field = mysqli_fetch_assoc($res))
	...
	<?php
		...
		while($db_field=mysqli_fetch_assoc($que_data))
		{
			...
			{ 
					print"<td>
					<table class=''style='margin-left:2.5%' >
                   <tr> <td><input type='radio' name='s[$j][$i]' value='1' required id='".$w."'></td><td style='padding-left:5px'><label for='".$w."'>Poor</label></td></tr>
				<tr> <td><input type='radio' name='s[$j][$i]' value='2' required id='".($w+1)."'></td><td style='padding-left:5px'><label for='".($w+1)."'>Satisfactory</label></td></tr>
					<tr> <td><input type='radio' name='s[$j][$i]' value='3' required id='".($w+2)."'></td><td style='padding-left:5px'><label for='".($w+2)."'>Good</label></td></tr>
					<tr> <td><input type='radio' name='s[$j][$i]' value='4' required id='".($w+3)."'></td><td style='padding-left:5px'><label for='".($w+3)."'>very Good</label></td></tr>
					<tr> <td><input type='radio' name='s[$j][$i]' value='5' required id='".($w+4)."'></td><td style='padding-left:5px'><label for='".($w+4)."'>Excellent</label></td></tr><br><br>
					</table></td>";
			}
    ...
    <center>
        <button type="submit" name="submit" value="submit" class='btn btn-primary' style='margin-bottom:20px;'>
