...
if(isset($_POST['add'])){
	...
	$sql1 = mysqli_query($conn, "ALTER TABLE `cm_feed` ADD  `$a`   INT(1) NOT NULL default 0;");
...
<head>
    ...
    <title>Update Feedback Questions | SLIET Feedback System</title>
...
<body>
    ...
    <div id="wrapper" class="wrapper">
        ...
        <nav class="navbar-default navbar-static-side" role="navigation">
            ...
            <div class="sidebar-collapse" >
                ...
                <ul class="nav" id="side-menu" style="background-color:#323232;">
                    ...
                    <li>
                        <a href="subanalyzefeedback.php"><i class="fa fa-home fa-fw"></i> Home</a>
                    </li>
                    <li>
        ...
        <div id="page-wrapper">
            ...
            <form action="subquestion.php" method="POST">
                     ...
                     <tr style='border: 1px solid black'>
                        ...
                        <?php
                         ...
                         while ($db_field = mysqli_fetch_assoc($result))
                         {
                             ...
                             $j = $i + 1;
                             print("<td align = 'center'><a href = 'delete.php?key=".$a."'><span style='position: relative; right: 15%;'>Delete</span></a></tr>");
                             $i = $i + 1;
                         }
