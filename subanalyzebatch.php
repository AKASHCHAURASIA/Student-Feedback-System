...
str=str+","+str2;
	   ...
	   var xmlhttp = new XMLHttpRequest();
        ...
        xmlhttp.open("GET", "faculty4.php?q="+str, true);
        xmlhttp.send();
        ...
        <nav class="navbar-default navbar-static-side" role="navigation">
            ...
            <div class="sidebar-collapse" >
                ...
                <ul class="nav" id="side-menu" style="background-color:#323232">
                    ...
                    <li>
                        <a href="subquestion.php"><i class="fa fa-pencil fa-fw"></i> Update feedback questions</a>
                    </li>
                    <li>
                    ...
                    <li>
                        <a href="presubanalyzefeedback.php"><i class="fa fa-clock-o fa-fw"></i> Previous Feedback Reports</a>
                    </li>
        ...
        <div id="page-wrapper">
           ...
           <div class="header">
            ...
            <div class="row">
                ...
                <label>Course</label>
                <select id='kl2' class="form-control select2 select2-hidden-accessible" style="width: 100%" tabindex="-1" aria-hidden="true" onmouseup="s()" required>
                  <option value='Degree(4-Year)' selected="selected">Degree(4-Year)</option>
                  <option value='Degree(3-Year)'>Degree(3-Year)</option>
                </select>
              </div>
              <div class="form-group col-lg-3">
                <label>Branch</label>
                <select id='kl' class="form-control select2 select2-hidden-accessible" style="width: 100%" tabindex="-1" aria-hidden="true" required>
                  <option  value="CM"  selected="selected">Computer Science and Engineering</option>
			  ...
			  <div id='hj'>
                <label>Batch</label>
                <select  id='kl1' class="form-control select2 select2-hidden-accessible" style="width: 100%" tabindex="-1" aria-hidden="true" onmouseup='s()'>
                  <option value='12'>Select a Batch</option>
