...
<div id='go'>
                    <div class="showcase" id="">
                            <li class="a"> 
                                <a href="cmhodprefeebackbatch.php"><img src="assets/img/thumb1.jpg" alt="web3canvas">
                            ...
                            <li class="a">
                                <a href="cmhodprefeebackteacher.php"><img src="assets/img/thumb2.jpg" alt="web3canvas">
