...
echo "</table></div>";
  ...
  echo "<br><br><h4>Details:</h4>";

		echo "<table border='2' style='width:55%''>";
	...
	$que_count = count($questions);
	     ...
	     $j=0;
		$re = mysqli_query($conn, "SELECT * FROM q_type");
		
		while ($db_field = mysqli_fetch_assoc($re))
	{
		$quality = $db_field['q_type'];
...
echo "</table><br><br><input type='button' onclick='PrintDiv();' value='Print' />";
	}
