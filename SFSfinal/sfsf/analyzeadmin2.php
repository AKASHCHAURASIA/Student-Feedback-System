...
<body>
    ...
    <div id="wrapper" >
        ...
        <div id="page-wrapper">
            ...
            <div class="row">
                ...
                <div class="col-lg-12">
		<div id='go'>			
			<h1 class="page-header" style="font-size: 18px;"><?php echo $_SESSION['year']."(Group-".$group."".$group1.")";?>&nbsp;Feedback for&nbsp;<?php echo $_SESSION['teacher_name'];?> </h1>
	...
	$res1 = mysqli_query($conn, "SELECT * FROM users WHERE year='$year' AND chk='1' AND (u_group='$group1' OR u_group='$group')  AND branch='$branch'");
