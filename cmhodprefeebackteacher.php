...
if(isset($_POST['year'])){
	header ("Location: presubanalyzecmhod2.php");
...
<head>
    ...
    <title>Analyze Teacher | SLIET Feedback System</title>
...
var str = e.options[e.selectedIndex].value;
	   ...
	   var xmlhttp = new XMLHttpRequest();
        ...
        xmlhttp.open("GET", "batch1.php?q="+str, true);
        xmlhttp.send();
...
var str = e.options[e.selectedIndex].value;
var e = document.getElementById("kl4");
...
str=str+","+str2+","+str3;
	   ...
	   var xmlhttp = new XMLHttpRequest();
        ...
        xmlhttp.open("GET", "faculty5.php?q="+str, true);
        xmlhttp.send();
...
var str3 = e.options[e.selectedIndex].value; 
var e = document.getElementById("kl4");
var str4 = e.options[e.selectedIndex].value;
...
var str = e.options[e.selectedIndex].value;
	   ...
	   var xmlhttp = new XMLHttpRequest();
        ...
        xmlhttp.open("GET", "date1.php?q="+str, true);
        xmlhttp.send();
    ...
    <div id="wrapper" >
        ...
        <div id="page-wrapper">
            ...
            <div class="row">
                ...
                <label>Course</label>
                <select id='kl2' class="form-control select2 select2-hidden-accessible" " tabindex="-1" aria-hidden="true" onmouseup="s()">
              ...
              <div class="form-group col-lg-8">
                <label>Branch</label>
                <select id='kl' class="form-control select2 select2-hidden-accessible" ;" tabindex="-1" aria-hidden="true" onmouseup="s4()"   >
                  <option value='CM' selected="selected">Select a Branch</option>
			  ...
			  <div id='hj'>
                <label>Batch</label>
                <select  id='kl1' class="form-control select2 select2-hidden-accessible" " tabindex="-1" aria-hidden="true">
...
<div class="form-group col-lg-8">
			  <div id='pol'>
                ...
                <select id='kl4' class="form-control select2 select2-hidden-accessible" style="width: 50%;" tabindex="-1" aria-hidden="true" onmouseover='s1()' >
			  ...
			  <div id='ty'>
                <label>Faculty</label>
				 <div id='ty'>
                <select id='kl3' class="form-control select2 select2-hidden-accessible" style="width: 50%;" tabindex="-1" aria-hidden="true" >
