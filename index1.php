   ...
   if($xml4[0]=='You have successfully logged in.DO NOT SHARE YOUR CYBEROAM PASSWORD.CYBEROAM Password must meet complexity.' ||  $xml4[0]=='You have reached Maximum Login Limit. (Already Logged In Somewhere)' || $xml4[0]=='Your data transfer has been exceeded, Wait for Restoration of Your Limit (Next Day)')
	...
	if(mysqli_num_rows($res))
	{
		...
		if($user == $db_user)
		{
			...
			else if($db_group1=='Contract_2014-15' || $db_group1=='Open Group' || $db_group1=='employee')
...
<body id="page-top" class="index">
    ...
    <nav id="mainNav" class="navbar navbar-default navbar-fixed-top navbar-custom">
        <div class="container">
            ...
            <div class="navbar-header page-scroll">
                ...
                <a class="navbar-brand" href="#page-top">Sliet longowal</a>
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li class="page-scroll">
					 ...
					 <li class="page-scroll">
                        <a href="http://sliet.ac.in/">Official Website</a>
                    </li>
            ...
            <div class="row">
                <div class="col-lg-6">
                    ...
                    <div class="intro-text">
						<img class='img-circle' src="images/logo.png" alt="" height='150PX'>
                        <span class="skills mobile-hide">SANT LONGOWAL INSTITUTE OF ENGINEERING AND TECHNOLOGY</span>
                        <hr class="star-light mobile-hide">
                        <span class="skills mobile-hide">Student Feedback System - Ready For- Smart Experience</span>
                    </div>
  ...
  <form class="login" method="POST" action="" style="display: inline-block">
	...
	<p class="subtitle" align="center">Use Cyberoam ID</p>
